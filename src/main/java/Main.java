...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (; ; ) {
            try {
                ...
                logger.info(SEARCH, "Пользователь ввел станцию отправления: {}", from);
                Station to = takeStation("Введите станцию назначения:");
                logger.info(SEARCH, "Пользователь ввел станцию назначения: {}", to);
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            logger.info(ERRORS, "Станция не найдена: " + line);
